...
import eid10 from "../../public/Animation - 1714076815671.json";
function Footer() {
  const { user } = useUser();

  return (
    user && (
      <footer className="bg-white lg:grid lg:grid-cols-5 dark:bg-gray-900 mt-5">
        ...
        <div className="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
          ...
          <Lottie animationData={eid10} style={{ height: "250px" }} />{" "}
          <div className="mt-12 border-t border-gray-100 pt-12 dark:border-gray-800">
            <div className="sm:flex sm:items-center sm:justify-between">
              ...
              <p className="mt-8 text-xs text-gray-500 sm:mt-0 dark:text-gray-400">
                &copy; 2024. Omar Abdalrahman. All rights reserved.
              </p>
            </div>
          </div>
        </div>
